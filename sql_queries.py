...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays (songplay_id SERIAL PRIMARY KEY, start_time float NOT NULL, user_id int NOT NULL, level varchar NOT NULL, song_id varchar, artist_id varchar, session_id int, location varchar NOT NULL, user_agent varchar)
""")

user_table_create = ("""CREATE TABLE IF NOT EXISTS users (user_id int UNIQUE, first_name varchar, last_name varchar, gender varchar, level varchar) 
""")
...
time_table_create = ("""CREATE TABLE IF NOT EXISTS time (start_time float PRIMARY KEY, hour int, day int, week int, month int, year int, weekday int)
""")
